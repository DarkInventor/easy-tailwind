  ...
  return (
    <BackgroundBeamsWithCollision>
      <div className="mt-0 flex flex-col justify-center gap-4">
        <h2 className="text-4xl relative z-20 md:text-4xl lg:text-7xl font-bold text-center text-white font-sans tracking-tight">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 w-[50%] mx-auto py-2">
